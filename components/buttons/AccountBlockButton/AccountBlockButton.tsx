...
export const AccountBlockButton = ({
  ...
  switch (type) {
    ...
    case "link":
      return (
        <Link href={to}>
          <a className="flex items-center justify-center rounded-lg text-lg text-gray-600 hover:bg-blue-400 hover:text-white">
      ...
      return (
        <button
          ...
          className={classNames(
            "flex h-8 w-full items-center justify-center rounded-lg  py-1",
            activeCategory === id ? "bg-blue-400 text-white" : "bg-gray-100"
          )}
        >
          {title}
        </button>
